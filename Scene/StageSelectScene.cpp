...
void StageSelectScene::Initialize() {
    ...
    for(int i=0;i<3;i++){
        btn = new Engine::ImageButton("stage-select/dirt.png", "stage-select/floor.png", halfW - 200, h0 -50 + deltah*i, 400, 100);
    ...
    btn = new Engine::ImageButton("stage-select/dirt.png", "stage-select/floor.png", halfW - 200, halfH / 2 + 350 -50, 400, 100);
